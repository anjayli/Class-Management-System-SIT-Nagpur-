...
<!DOCTYPE html>
<html>
<head>   <title> LOGIN AS TEACHER </title> </head>
...
<body>
    ...
    <div class="topnav">
        ...
        <a href="addattendance.php"> Mark Attendence </a>
        <a href="addmarks.php"> Asign Marks </a>
        <a href="#make_report"> Make Progress Report for Student </a>
    ...
    <form>
        <h1 align="center"> You have Login as Teacher </h1>  
